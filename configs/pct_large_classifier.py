...
model = dict(
    type='PCT',
    # pretrained='/home/morzh/work/fitMate/repositories/PCT/weights/heatmap/swin_large.pth',
    pretrained='/home/morzh/work/fitMate/repositories/PCT/weights/pct/swin_large.pth',
    ...
    keypoint_head=dict(
        ...
        tokenizer=dict(
            guide_ratio=0.5,
            ckpt="/home/morzh/work/fitMate/repositories/PCT/weights/tokenizer/swin_large.pth",
            encoder=dict(
                drop_rate=0.2,
                num_blocks=4,
                hidden_dim=512,
